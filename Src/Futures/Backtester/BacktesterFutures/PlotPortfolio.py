...
from .plot_histogram_returns import plot_histogram_returns
from .plot_qq_returns import plot_qq_returns

matplotlib.use("Qt5Agg")


def draw_chart(cumulative_df, cumulative, portfolio_dollar, table_df):
...
class PlotPortfolio(PlotBase):
    ...
    def run(self):
        ...
        draw_chart(cumulative_df, cumulative, portfolio_dollar, table_df)
